...
public:
	...
	void bindObstacleVBO(unsigned int programID, glm::vec3 p);
	...
	/*	===============================================
		...
		Postcondition:
	=============================================== */
	void renderVBO(unsigned int shaderProgramID);
	/*	===============================================
...
private:
	...
	// Id for Vertex Array Object
	GLuint vao;
	// Id for Vertex Buffer Object
	GLuint vertexVBO_id, indicesVBO_id, normalVBO_id, obstacle_id;
};
